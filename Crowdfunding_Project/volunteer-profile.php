                            ...
                            <div class="volunteer-profile-container mt-5">
                                ...
                                <form id="profileForm" class="volunteer-profile-form">
                                    ...
                                    <div class="volunteer-profile-field" style="grid-column: span 2;">
                                        ...
                                        <div class="volunteer-profile-images">
                                            <div id="aadharUpload" class="volunteer-profile-image-upload">
                                                <img src="/api/placeholder/150/150" alt="Aadhar Card" class="volunteer-profile-preview">
                                                <input type="file" id="aadharInput" class="volunteer-profile-file-input" accept="image/*" disabled>
                                                <div class="volunteer-profile-image-icon">📄</div>
                                                <span class="volunteer-profile-image-text">Aadhar Image</span>
                                            </div>
                                            
                                            <div id="panUpload" class="volunteer-profile-image-upload">
                                                <img src="/api/placeholder/150/150" alt="PAN Card" class="volunteer-profile-preview">
                                                <input type="file" id="panInput" class="volunteer-profile-file-input" accept="image/*" disabled>
                                                <div class="volunteer-profile-image-icon">📄</div>
                                                <span class="volunteer-profile-image-text">PAN Image</span>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editBtn.addEventListener('click', function() {
                ...
                // Add active class to image uploads
                aadharUpload.classList.add('active');
                panUpload.classList.add('active');
            ...
            cancelBtn.addEventListener('click', function() {
                ...
                // Remove active class from image uploads
                aadharUpload.classList.remove('active');
                panUpload.classList.remove('active');
            ...
            aadharUpload.addEventListener('click', function() {
                if (!aadharInput.disabled) {
                    aadharInput.click();
                }
            });
            
            panUpload.addEventListener('click', function() {
                if (!panInput.disabled) {
                    panInput.click();
                }
            });
            ...
            aadharInput.addEventListener('change', function(e) {
                if (e.target.files && e.target.files[0]) {
                    ...
                    reader.onload = function(e) {
                        aadharUpload.querySelector('.volunteer-profile-preview').src = e.target.result;
                    };
            ...
            panInput.addEventListener('change', function(e) {
                if (e.target.files && e.target.files[0]) {
                    const reader = new FileReader();
                    reader.onload = function(e) {
                        panUpload.querySelector('.volunteer-profile-preview').src = e.target.result;
                    };
                    reader.readAsDataURL(e.target.files[0]);
                }
            });
