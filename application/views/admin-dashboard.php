                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-12"> <!-- Default box -->
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="initial-boxes-card">
                                            <i class="fa-solid fa-person initial-boxes-icon"></i>
                                            <div class="initial-boxes-title">Total Number of Volunteers</div>
                                            <div class="initial-boxes-value">12</div>
                                            <button class="initial-boxes-btn">Manage Volunteers</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="initial-boxes-card">
                                            <i class="fa-solid fa-people-line initial-boxes-icon"></i>
                                            <div class="initial-boxes-title">Numbers of Active Volunteers</div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="initial-boxes-card">
                                            <i class="fa-solid fa-hand-holding-heart initial-boxes-icon"></i>
                                            <div class="initial-boxes-title">Total numbers of Donors</div>
                            ...
                            <div class="quick-actions-container mb-5">
                                
                                <div class="d-history-header">Quick Actions</div>
                                <div class="quick-actions-btn d-flex justify-content-evenly">
                                   <button class="d-history-manage-btn">Create Campaigns</button> 
                                   <button class="d-history-manage-btn">Schedule Appointments</button> 
                                   <button class="d-history-manage-btn">Message to Volunteers</button> 
                                </div>
